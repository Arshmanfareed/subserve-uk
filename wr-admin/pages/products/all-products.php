...
<head>
  ...
  <title>All Products | Subserve UK</title>
...
<div class="wrapper">
  ...
  // SEARCH FILTER CATEOGRY
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $product_query = 'SELECT id, product_name, image_url, sale_price, current_price, category_id, brand_id, slug, part_no, is_archive FROM products WHERE id IS NOT NULL AND is_archive = 0 '.$product_query_clause;
    }
    else{
        $product_query = 'SELECT id, product_name, image_url, sale_price, current_price, category_id, brand_id, slug, part_no, is_archive FROM products WHERE is_archive = 0 ';
        $product_query_clause = '';
    }
    
    $queryTotalCount = "SELECT COUNT(*) as total FROM products WHERE id IS NOT NULL AND is_archive = 0  $product_query_clause";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="wr-admin-all-products-title">Products <small>(total <?php echo $totalCount[0]; ?>)</small></h1>
          </div>
         <div class="col-sm-6">
                    ...
                    ?>
                          <tr>
                            ...
                            <td>
                                ...
                                <a href="archive_product.php?id=<?php echo $product['id']; ?>" class="btn btn-secondary btn-sm" onclick="return confirm('Are you sure you want to archive this product?');">Archive</a> |
                    ...
                    <div class="card-footer clearfix">
                        <ul class="pagination pagination-sm m-0 ">
                          <?php
                                ...
                                $url = '/subserve/wr-admin/pages/products/all-products.php';
                                $links = "";
