...
$get_categories_slug = "SELECT * FROM categories";
                        ...
                        <div class="row nopadding">
                            ...
                            if ($get_product_result->num_rows > 0) {
                                ...
                                while ($product = $get_product_result->fetch_assoc()) {
                                    ...
                                    echo '<span class="price-1 color">$' . $product['purchase_price'] . ' (Exc. Vat) </span>';
                                    echo '<span class="price-2 color">$' . $product['sale_price'] . ' (Inc. Vat) </span>';
                                    echo '</div>';
                                    echo '<div class="icons">';
                                    echo '<a class="entry AddToCartTic sasddasasdasd" ><i class="fa fa-check" aria-hidden="true"></i></a>';
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            ...
                                            <div class="product-big-preview-entry swiper-lazy"
                                                data-background="assets/img/products-img/H106060SDSUN600G.webp" id="productMainImg"></div>
                                        </div>
                                    </div>
                                </div>
